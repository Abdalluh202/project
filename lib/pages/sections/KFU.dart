...
class KFU extends StatefulWidget {
  const KFU({Key? key}) : super(key: key);

  @override
  State<KFU> createState() => _KFUState();
}

List list = [];

class _KFUState extends State<KFU> {
  var Scresh;

  get controller => null;
  Future ReadData() async {
    var url = "https://104.234.147.107/getkfu.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: [
          TitelPage(context, "جامعة الملك فيصل", kohel),
