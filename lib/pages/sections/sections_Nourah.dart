...
class sections_Nourah extends StatefulWidget {
  @override
  State<sections_Nourah> createState() => _sections_KSUState();
}

class _sections_KSUState extends State<sections_Nourah> {
  int select_item = 0;
  List list = [];
  ...
  Future ReadData() async {
    var url = "https://104.234.147.107/getnou.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: [
          TitelPage(context, "جامعة الأميرة نورة",kohel),
