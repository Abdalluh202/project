...
class TVTC extends StatefulWidget {
  const TVTC({Key? key}) : super(key: key);

  @override
  State<TVTC> createState() => _TVTCState();
}

List list = [];

class _TVTCState extends State<TVTC> {
  var Scresh;
  ...
  Future ReadData() async {
    var url = "https://104.234.147.107/gettvtc.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: [
          TitelPage(context, "كلية التقنية",kohel),
