...
class sections_imamu extends StatefulWidget {
  @override
  State<sections_imamu> createState() => _sections_KSUState();
}

List list = [];

class _sections_KSUState extends State<sections_imamu> {
  get controller => null;
  Future ReadData() async {
    var url = "https://104.234.147.107/getimamu.php";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(
        children: [
          TitelPage(context, "جامعة الأمام محمد",kohel),
          SizedBox(
            height: 35,
          ),
